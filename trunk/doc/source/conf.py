# -*- coding: utf-8 -*-
#
# openxmllib documentation build configuration file, created by
# sphinx-quickstart on Sun Nov 21 13:53:54 2010.
#
...
def _getVersion():
    # Use the version of the source package
    this_dir = os.path.dirname(__file__)
    version_file = os.path.join(_projectRoot(), 'openxmllib', 'version.txt')
...
htmlhelp_basename = 'openxmllibdoc'
